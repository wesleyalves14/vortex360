...
export function BackgroundShapes({ className }: { className?: string }) {
  return (
    <div
      aria-hidden
      className={cn(
        // fica fixo atrás do site inteiro
        "pointer-events-none fixed inset-0 z-0 overflow-hidden",
        className
      )}
    >
      {/* base sutil + glow */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#030303] via-[#030303]/80 to-[#030303]/60" />
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/[0.12] via-transparent to-rose-500/[0.12] blur-3xl" />

      {/* shapes flutuando (mesma estética do herogeometric) */}
      <ElegantShape
        delay={0.3}
        width={600}
        height={140}
